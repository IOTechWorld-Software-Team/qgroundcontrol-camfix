...
Button {
    ...
    property bool   armingButton:   false
    property bool   primary:        false                               ///< primary button for a group of buttons
    property real   pointSize:      ScreenTools.largeFontPointSize    ///< Point size for button text
    ...
    style: ButtonStyle {
            ...
            background: Rectangle {
                ...
                color:          !armingButton ? (_showHighlight ? control._qgcPal.novButtonHighlight : (primary ? control._qgcPal.primaryButton : control._qgcPal.button)) : (_armed ? control._qgcPal.colorRed : control._qgcPal.novButtonHighlight)                                
            }
