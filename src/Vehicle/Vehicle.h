...
public:
    ...
    Q_PROPERTY(int activeLinkAM          READ activeLinkAM         NOTIFY onActiveLinkAMChanged)
    ...
    int activeLinkAM(void)         { return _activeLinkAM; }
...
signals:
    ...
    void onActiveLinkAMChanged(void);
...
private:
    ...
    // raw airpi radio status message
    int _sbd_quality = 0;
    int _sms_quality1 = 0;
    int _sms_quality2 = 0;
    int _sms_quality3 = 0;
